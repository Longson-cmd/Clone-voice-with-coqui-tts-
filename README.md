# 🎙️ Clone Voice with Coqui TTS

This project demonstrates how to **clone voices** and generate **speech in multiple languages** using [Coqui TTS](https://github.com/coqui-ai/TTS).  
It also includes utilities for **text processing**, **audio editing**, and **subtitle generation** for multilingual voice synthesis workflows.
